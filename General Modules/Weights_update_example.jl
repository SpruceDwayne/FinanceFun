...
optimal_weights = optimize_portfolio_CVaR_const(-matrix_data[1:end,2:end],0.05,0.95,false)
#
#=
...
new_weights, updates = CVaR_functions.update_portfolio_weights(current_weights,-matrix_data[1:end,2:end],0.05,9999,false,0.02,0.95)
...
new_weights, updates = CVaR_functions.update_portfolio_weights(current_weights,-matrix_data[1:end,2:end],0.05,9999,false,0.01,0.95)
println(new_weights[1:n]-new_weights[n+1 : 2*n])
new_weights, updates = CVaR_functions.update_portfolio_weights(current_weights,-matrix_data[1:end,2:end],0.05,9999,false,0.005,0.95)
println(new_weights[1:n]-new_weights[n+1 : 2*n])

new_weights, updates = CVaR_functions.update_portfolio_weights(current_weights,-matrix_data[1:end,2:end],0.05,9999,false,0.0005,0.95)
println(new_weights[1:n]-new_weights[n+1 : 2*n])

new_weights, updates = CVaR_functions.update_portfolio_weights(current_weights,-matrix_data[1:end,2:end],0.05,9999,false,0.0002,0.95)
println(new_weights[1:n]-new_weights[n+1 : 2*n])

new_weights, updates = CVaR_functions.update_portfolio_weights(current_weights,-matrix_data[1:end,2:end],0.05,9999,false,0.0,0.95)
println(new_weights[1:n]-new_weights[n+1 : 2*n])
